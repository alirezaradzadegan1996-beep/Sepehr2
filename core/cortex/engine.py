...
class CortexEngine:
    ...
    def average_time(self):
        ...
        return self.stats["total_time"] / self.stats["runs"]
    ...
    def report(self):
        ...
        return {
            ...
            "middlewares": len(self.middleware),
            "before_hooks": len(self.before_hooks),
            "after_hooks": len(self.after_hooks),
        }
